...
> Note: `src/**/*.java` is a bash/zsh-style glob pattern. On shells that do not support it, list files explicitly (e.g., `javac -d out src/Main.java src/utils/Helper.java`).
